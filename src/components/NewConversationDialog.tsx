...
const CHANNELS: {
  id: string
  label: string
  /** The trigger node name the workspace expects on a workflow. */
  trigger: string
...
const CONTACT: Record<string, { label: string; type: string; placeholder: string }> = {
...
export default function NewConversationDialog({
  ...
  open: boolean
  onClose?: () => void
  onStarted?: (started: StartedConversation) => void
}) {
  // CHANNELS is a non-empty literal, so there is always a first entry; the
  // assertion is about `noUncheckedIndexedAccess`, not about doubt.
